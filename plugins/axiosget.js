...
╰─────────────────◆ `;
    ...
    await zk.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "BUMBLEBEE-XMD HOLY BIBLE",
      ...
      await zk.sendMessage(dest, {
        ...
        contextInfo: {
          externalAdReply: {
            ...
            mediaType: 1,
            thumbnailUrl: "https://files.catbox.moe/etqc8k.jpg", 
            sourceUrl: conf.GURL,
            showAdAttribution: true, 
          },
        },
...
zokou({
  ...
  if (!arg || arg.length === 0) {
    const replyText = "Example Usage: .code 254759xxxxxx.";
    return repondre(replyText);
  }

  try {
    // Notify user that pairing is in progress
    const replyText = "*Bumblebee-XMD is getting your pair code ♻️✅...*";
...
*Bumblebee-XMD Element Information:*
👑 *Name:* ${data.name}
⚫ *Symbol:* ${data.symbol}
...
Regards ${conf.BOT} `;
    ...
    await zk.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "BUMBLEBEE-XMD ELEMENT INFORMATION",
...
`;
    ...
    await zk.sendMessage(dest, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "BUMBLEBEE-XMD GITHUB USER INFO",
